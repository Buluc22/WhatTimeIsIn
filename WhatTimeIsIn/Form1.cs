namespace WhatTimeIsIn
{
    public partial class Form1 : Form
    {
        ...
        {
            var localDate = _timeZoneService.GetCurretDateByTimeZone("Eastern Standard Time");
        ...
        {
            var localDate = _timeZoneService.GetCurretDateByTimeZone("China Standard Time");
        ...
        {
            var localDate = _timeZoneService.GetCurretDateByTimeZone("Tokyo Standard Time");
